...
public class View extends JPanel {
    ...
    /**
     * constructor will initialize JFrame and other components that will be on
     * it.
     */
    public View() {
        frame = new JFrame();
...
//   		frame2.drawImage(ospreyImg.getImage(),100,100,100,100, null);
    ...
    /**
     * createImage() will create a BufferedImage that will be loaded into an
     * array
     *
...
//                    + path + ".png"));
    ...
    /**
     * update() will update the attributes within View based off of the values
     * that are determined in Model.
     *
    ...
    /**
     * displayStartScreen() will display the visual at the beginning of the game
     * and can be recalled when the player dies or goes to the next bird.
     */
    ...
    /**
     * displayMiniMap() will be called every tick to update the bird's location
     * on the miniMap to see it's progress
     */
